...
mongoose.connect(
  "mongodb+srv://amit_123:amit1234@try-fqtvg.mongodb.net/test?retryWrites=true&w=majority",
...
app.put("/query", function(req, res) {
  ...
  Umodel.updateOne({ email: email }, { $set: { Issue: Issue } }).exec();
